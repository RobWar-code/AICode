...
const rulesets = {
    ...
    ruleCompletionRound: new Array(65).fill(-1),
    seedRuleNum: 9,
    seedRuleMemSpaces: [],
    seedRuleFragments: [],
    seedRuleSet: false,
    ...
    initialise() {
        ...
        this.requiredOutputsFunction.push(this.getAddParamRequiredOutputs);
        ...
        let scoreItem44 = {rule: "Sort Params", ruleId: 64,
        ...
        let scoreItem45 = {rule: "Add Adjacent Params", ruleId: 27,
        ...
        let scoreItem46 = {rule: "Subtract Adjacent Params", ruleId: 28,
        ...
        let scoreItem47 = {rule: "Multiply Adjacent Params", ruleId: 29, 
        ...
        let scoreItem48 = {rule: "Divide Adjacent Params", ruleId: 30, 
        ...
        let scoreItem49 = {rule: "Use op to Convert Adjacent Params 1", ruleId: 57, 
        ...
        let scoreItem50 = {rule: "Use op to Convert Adjacent Params 2", ruleId: 58, 
        ...
        let scoreItem51 = {rule: "Use op to Convert Adjacent Params 3", ruleId: 59, 
        ...
        // Multiply
        let scoreItem52 = {rule: "Use op to Convert Adjacent Params 4", ruleId: 60, 
        ...
        // Modulo
        let scoreItem53 = {rule: "Use op to Convert Adjacent Params 5", ruleId: 61, 
        ...
        // Divide
        let scoreItem54 = {rule: "Use op to Convert Adjacent Params 6", ruleId: 62, 
        ...
        let scoreItem55 = {rule: "Use op to Convert Adjacent Params 7", ruleId: 54, 
        ...
        let scoreItem56 = {rule: "Use op to Convert Adjacent Params 8", ruleId: 55, 
        ...
        let scoreItem57 = {rule: "Use op to Convert Adjacent Params 9", ruleId: 56, 
        ...
        let scoreItem58 = {rule: "Use op to Convert Adjacent Params 10", ruleId: 31,
        ...
        let scoreItem59 = {rule: "Convert ASCII Numbers 1", ruleId: 32,
        ...
        let scoreItem60 = {rule: "Convert ASCII Numbers 2", ruleId: 33,
        ...
        let scoreItem61 = {rule: "Convert ASCII Numbers 2", ruleId: 34,
        ...
        let scoreItem62 = {rule: "Convert ASCII Numbers 2", ruleId: 35,
        ...
        this.outputScoresItem = 63;
        let scoreItem63 = {rule: "Output Scores Equal", ruleId: 63, retain: true, skip: false, 
            sequenceNum: 0, score: 0, max: 2, startRoundNum: 0};
        ...
        this.diffScore = 64;
        let scoreItem64 = {rule: "Difference Between Outputs", ruleId: 36, retain: true, skip: false, 
    ...
    initialiseOutputData() {
        for (let i = 0; i < this.scoreList.length; i++) {
            if (this.requiredOutputsFunction[i] != null) {
                let outputList = this.requiredOutputsFunction[i](this, this.scoreList[i]);
    ...
    getOutputSeriesRequiredOutputs(self, ruleParams) {
        let paramsList = ruleParams.paramsIn;
        let outputList = [];
    ...
    getOutputSeriesOfSeriesRequiredOutputs(self, ruleParams) {
        let paramsList = ruleParams.paramsIn;
        let outputList = [];
    ...
    getAddFirstParamsRequiredOutputs(self, ruleParams) {
        let inputList = ruleParams.paramsIn;
        let outputList = [];
    ...
    getSubtractFirstParamRequiredOutputs(self, ruleParams) {
        let inputList = ruleParams.paramsIn;
        let outputList = [];
    ...
    getOddAndEvenParamsRequiredOutputs(self, ruleParams) {
        let inputList = ruleParams.paramsIn;
        let outputList = [];
    ...
    getMultiplyByFirstParamRequiredOutputs(self, ruleParams) {
        let inputList = ruleParams.paramsIn;
        let outputList = [];
    ...
    getModuloFirstParamRequiredOutputs(self, ruleParams) {
        let inputList = ruleParams.paramsIn;
        let outputList = [];
    ...
    getDivideByFirstParamRequiredOutputs(self, ruleParams) {
        let inputList = ruleParams.paramsIn;
        let outputList = [];
    ...
    getGreaterThanFirstParamRequiredOutputs(self, ruleParams) {
        let inputList = ruleParams.paramsIn;
        let outputList = [];
    ...
    getCompareFirstParamRequiredOutputs(self, ruleParams) {
        let inputList = ruleParams.paramsIn;
        let outputList = [];
    ...
    getDuplicateParamsRequiredOutputs(self, ruleParams) {
        let inputList = ruleParams.paramsIn;
        let outputList = [];
    ...
    getSkipAdjacentParams1RequiredOutputs(self, ruleParams) {
        let inputList = ruleParams.paramsIn;
        let outputList = [];
    ...
    getSkipAdjacentParams2RequiredOutputs(self, ruleParams) {
        let inputList = ruleParams.paramsIn;
        let outputList = [];
    ...
    getSwapAdjacentParamsRequiredOutputs(self, ruleParams) {
        let inputList = ruleParams.paramsIn;
        let outputList = [];
    ...
    getGreaterOfAdjacentParamsRequiredOutputs(self, ruleParams) {
        let inputList = ruleParams.paramsIn;
        let outputList = [];
    ...
    getSortAdjacentParamsRequiredOutputs(self, ruleParams) {
        let inputList = ruleParams.paramsIn;
        let outputList = [];
    ...
    getSortParamsRequiredOutputs(self, ruleParams) {
        let inputList = ruleParams.paramsIn;
        let outputList = [];
    ...
    getAddAdjacentParamsRequiredOutputs(self, ruleParams) {
        let inputList = ruleParams.paramsIn;
        let outputList = [];
    ...
    getSubtractAdjacentParamsRequiredOutputs(self, ruleParams){
        let inputList = ruleParams.paramsIn;
        let outputList = [];
    ...
    getMultiplyAdjacentParamsRequiredOutputs(self, ruleParams) {
        let inputList = ruleParams.paramsIn;
        let outputList = [];
    ...
    getDivideAdjacentParamsRequiredOutputs(self, ruleParams) {
        let inputList = ruleParams.paramsIn;
        let outputList = [];
    ...
    getParamOperationsRequiredOutputs(self, ruleParams) {
        let inputList = ruleParams.paramsIn;
        let outputList = [];
    ...
    getConvertASCIINumbersRequiredOutputs(self, ruleParams) {
        let inputList = ruleParams.paramsIn;
        let outputList = [];
