const seedPrograms = {
    programs: [
        ...
        },
        {
            ...
            description: "divide adjacent params as indicated by / operator",
            program: [
                {
                    ins: "CLR (MEM)",
