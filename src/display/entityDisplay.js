const entityDisplay = {
    ...
    display(data) {
        ...
        function displayEntityDetails(data) {
            ...
            document.getElementById("weightedMonoclonalByteCount").innerText = data.weightedMonoclonalByteCount;
            document.getElementById("weightedRandomBreedCount").innerText = data.weightedRandomBreedCount;
            document.getElementById("selfBreedCount").innerText = data.selfBreedCount;
            document.getElementById("bestsStoreBreedCount").innerText = data.bestsStoreBreedCount;
